...
<script>
	...
	import alertTextMode from '@/pages_alertManagement/components/AlertTextMode.vue'
	import alertMapMode from '@/pages_alertManagement/components/AlertMapMode.vue'
	export default {
		components:{
			alertTextMode,
			alertMapMode
