	...
	<view>
		...
		<view class="btn-submit">
				...
				<uni-popup ref="message" background-color="#fff">
					...
					:DisasterRecordForm="DisasterRecordForm">
				</sendMessageTochang>
				</uni-popup>
			</view>
	</view>
...
<script>
	...
	import DisasterInformationChangeMode  from "@/components/DisaterRecord/DisasterInformationChangeMode.vue"
	import BasicInformationChangeMode from '@/components/DisaterRecord/BasicInformationChangeMode.vue'
	...
	export default {
		...
		methods: {
			changedata(){
				...
				console.log("this.DisasterRecordForm",this.DisasterRecordForm)
