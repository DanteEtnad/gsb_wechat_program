	...
	<view style="padding: 20px 5px;margin-top:15px; background-color: white;">
		<view class="item-container">
			...
			<uni-row >
				...
				<uni-col :span="16">
					<view class="select-input">
						<uni-easyinput type="textarea" 	v-model="disaster.reason" placeholder="请输入诱发原因" @input="DescriptionText"/></view>
				</uni-col>
			</uni-row>
			<!-- 防治措施 -->
			<uni-row >
				...
				<uni-col :span="16">
					<uni-easyinput type="textarea" v-model="disaster.cuoshi" placeholder="请输入防治措施" @input="PreventionText"/>
