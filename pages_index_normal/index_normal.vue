						...
						<uni-row>
							...
							<uni-col :span="6">
								<view class="index-icon-font" @click="toPages('pages_alertManagement/ProfessionDetect')">
									<view class="index-icon">
										<u--image class="logo" src="http://stdzpt.com:9000/index/zhuanyejiance.svg" width="48px" height="68px" mode="aspectFit"></u--image>
									</view>
								</view>
							</uni-col>
							<uni-col :span="6">
								<view class="index-icon-font" @click="toPages('pages_alertManagement/AroundPotential')">
									<view class="index-icon">
										<u--image class="logo" src="http://stdzpt.com:9000/index/zhoubianyinhuan.svg" width="48px" height="68px" mode="aspectFit"></u--image>
									</view>
								</view>
							</uni-col>
						</uni-row>
						...
						<uni-row>
							<uni-col :span="6">
								<view class="index-icon-font" @click="toPages('pages_alertManagement/AlertCreate')">
									<view class="index-icon">
										<u--image class="logo" src="http://stdzpt.com:9000/index/yujingdanchuangjian.svg" width="60px" height="68px" mode="aspectFit"></u--image>
									</view>
								</view>
							</uni-col>
							<uni-col :span="6">
								<view class="index-icon-font" @click="toPages('pages_alertManagement/AlertCheck')">
									<view class="index-icon">
										<u--image class="logo" src="http://stdzpt.com:9000/index/yujingdanshenpi.svg" width="60px" height="68px" mode="aspectFit"></u--image>
									</view>
								</view>
							</uni-col>
						</uni-row>
						...
						<uni-row>
							<uni-col :span="6">
								<view class="index-icon-font" @click="toPages('pages_DisasterRecord/DisasterDetails')">
									<view class="index-icon">
										<u--image class="logo" src="http://stdzpt.com:9000/index/zaiqingxiangqing.svg" width="48px" height="68px" mode="aspectFit"></u--image>
									</view>
								</view>
							</uni-col>
							<uni-col :span="6">
								<view class="index-icon-font" @click="toPages('pages_DisasterRecord/DisasterCount')">
									<view class="index-icon">
										<u--image class="logo" src="http://stdzpt.com:9000/index/zaiqingtongji.svg" width="48px" height="68px" mode="aspectFit"></u--image>
									</view>
								</view>
							</uni-col>
							<uni-col :span="6">
								<view class="index-icon-font" @click="toPages('pages_DisasterRecord/DisasterFillHistory')">
									<view class="index-icon">
										<u--image class="logo" src="http://stdzpt.com:9000/index/zaiqingtianbao.svg" width="48px" height="68px" mode="aspectFit"></u--image>
									</view>
								</view>
							</uni-col>
							<uni-col :span="6">
								<view class="index-icon-font" @click="toPages('pages_DisasterRecord/DisasterCheck')">
									<view class="index-icon">
										<u--image class="logo" src="http://stdzpt.com:9000/index/zaiqingshenhe.svg" width="48px" height="68px" mode="aspectFit"></u--image>
									</view>
								</view>
							</uni-col>
						</uni-row>
						...
						<uni-row>
							<uni-col :span="6">
								<view class="index-icon-font" @click="toPages('pages_patrolManagement/Patrolquery')">
									<view class="index-icon">
										<u--image class="logo" src="http://stdzpt.com:9000/index/shujvchaxun.svg" width="48px" height="68px" mode="aspectFit"></u--image>
									</view>
								</view>
							</uni-col>
							<uni-col :span="6">
								<view class="index-icon-font" @click="toPages('pages_patrolManagement/PatrolStatics')">
									<view class="index-icon">
										<u--image class="logo" src="http://stdzpt.com:9000/index/xunchatongji.svg" width="48px" height="68px" mode="aspectFit"></u--image>
									</view>
								</view>
							</uni-col>
							<uni-col :span="6">
								<view class="index-icon-font" @click="toPages('pages_patrolManagement/Patrolfill')">
									<view class="index-icon">
										<u--image class="logo" src="http://stdzpt.com:9000/index/shujvtianbao.svg" width="48px" height="68px" mode="aspectFit"></u--image>
									</view>
								</view>
							</uni-col>
							<uni-col :span="6">
								<view class="index-icon-font" @click="toPages('pages_patrolManagement/PatrolResultApproval')">
									<view class="index-icon">
										<u--image class="logo" src="http://stdzpt.com:9000/index/shujvshenpi.svg" width="48px" height="68px" mode="aspectFit"></u--image>
									</view>
								</view>
							</uni-col>
						</uni-row>
						...
						<uni-row>
							<uni-col :span="6">
								<view class="index-icon-font" @click="toPages('pages_DailyPatrol/DailyPatrol')">
									<view class="index-icon">
										<u--image class="logo" src="http://stdzpt.com:9000/index/kaizhanxuncha.svg" width="48px" height="68px" mode="aspectFit"></u--image>
									</view>
								</view>
							</uni-col>
							<uni-col :span="6">
								<view class="index-icon-font" @click="toPages('pages_DailyPatrol/DailyPatrolCount')">
									<view class="index-icon">
										<u--image class="logo" src="http://stdzpt.com:9000/index/xunchatongji1.svg" width="48px" height="68px" mode="aspectFit"></u--image>
									</view>
								</view>
							</uni-col>
							<uni-col :span="6">
								<view class="index-icon-font" @click="toPages('pages_DailyPatrol/DailyPatrolNote')">
									<view class="index-icon">
										<u--image class="logo" src="http://stdzpt.com:9000/index/xunchajilu.svg" width="48px" height="68px" mode="aspectFit"></u--image>
									</view>
								</view>
							</uni-col>	
						</uni-row>
