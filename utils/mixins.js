			...
			try {
				...
				if (res && res.code === 2000) {
					...
					if (resAlert && resAlert.code === 2000) {
						...
						this.potentialPointExpandData.hangingPointLead = this.isHasId(alertResponsibilityData
								.hangingPointLead) ? this.members[alertResponsibilityData.hangingPointLead]
							.memberName : ''
						this.potentialPointExpandData.hangingPointLeadPhone = this.isHasId(
							alertResponsibilityData.hangingPointLead) ? this.members[alertResponsibilityData
							.hangingPointLead].memberPhone : ''
						this.potentialPointExpandData.hangingPointLeadTelephone = this.isHasId(
							alertResponsibilityData.hangingPointLead) ? this.members[alertResponsibilityData
							.hangingPointLead].memberMobile : ''
						this.potentialPointExpandData.responsible = this.isHasId(alertResponsibilityData
								.responsible) ? this.members[alertResponsibilityData.responsible].memberName :
							''
						this.potentialPointExpandData.responsiblePhone = this.isHasId(alertResponsibilityData
								.responsible) ? this.members[alertResponsibilityData.responsible].memberPhone :
							''
						this.potentialPointExpandData.responsibleTelephone = this.isHasId(
							alertResponsibilityData.responsible) ? this.members[alertResponsibilityData
							.responsible].memberMobile : ''
						this.potentialPointExpandData.administrator = this.isHasId(alertResponsibilityData
								.administrator) ? this.members[alertResponsibilityData.administrator]
							.memberName : ''
						this.potentialPointExpandData.administratorPhone = this.isHasId(alertResponsibilityData
								.administrator) ? this.members[alertResponsibilityData.administrator]
							.memberPhone : ''
						this.potentialPointExpandData.administratorTelephone = this.isHasId(
							alertResponsibilityData.administrator) ? this.members[alertResponsibilityData
							.administrator].memberMobile : ''
						this.potentialPointExpandData.manager = this.isHasId(alertResponsibilityData.manager) ?
							this.members[alertResponsibilityData.manager].memberName : ''
						this.potentialPointExpandData.managerPhone = this.isHasId(alertResponsibilityData
							.manager) ? this.members[alertResponsibilityData.manager].memberPhone : ''
						this.potentialPointExpandData.managerTelephone = this.isHasId(alertResponsibilityData
							.manager) ? this.members[alertResponsibilityData.manager].memberMobile : ''
